...
The exact procedure for resolving a conflict with one of those lockfiles will depend on the package manager. See the [appendix on resolving lockfile conflicts](./appendix-lockfile-resolution.md) for platform-specific instructions. 
